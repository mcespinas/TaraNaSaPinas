...
class AgencyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $agency->agency_rating = $request->input('agency_rating');
        
        $agency->agency_logo = $fileNameToStore;
        
        $agency->save();

        return view('agencies.show')->with('agency', $agency)->with('success', 'Company Profile Created');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return view('agencies.show')->with('agency', $agency)->with('success', 'Company Profile Updated');
    }
